...
{
    return (
        <AccordionItem className="!border-none max-md:max-w-[350px] max-w-[960px] mx-auto" value={digitalProduct.id}>
            <AccordionTrigger className='w-full bg-[#EAEAEA] rounded-[12px]'>
                <div className="flex items-center justify-between min-w-[98%] border-none px-6">
                    ...
                    <div className='flex flex-col gap-2 items-start justify-center'>
                        <p className='text-xs lg:text-sm text-black font-normal font-poppins'>Seller's Role: {digitalProduct.role}</p>
                    </div>
                </div>
            </AccordionTrigger>
                        ...
                        <div className={cn('flex gap-2 w-full items-center justify-between bg-black px-4 py-2 text-white')}>
                            ...
                            {/* <div className='flex gap-2 items-center'>
                                <div className='p-1 bg-[#55555580] rounded-[4px] flex items-center justify-center text-center'>
                                    ...
                                    <p className='font-medium text-xs lg:text-sm font-poppins text-white'>{digitalProduct.country}</p>
                                </div>
